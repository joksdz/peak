...
- **Upcoming:** **Wallpaper Mode** — A dedicated feature to browse and set wallpapers directly from the interface.
-  **x11 support**
...
git clone [https://github.com/yourusername/peak.git](https://github.com/yourusername/peak.git)
cd peak
  ```
